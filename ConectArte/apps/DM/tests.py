...
from apps.DM.models import CanalMensaje, Canal, CanalUsuario
...
class CanalTestCase(TestCase):
    def setUp(self):
        self.usuario_a = User.objects.create(username='a', password ='1')
        self.usuario_b = User.objects.create(username='b', password ='2')
        self.usuario_c = User.objects.create(username='c', password ='3')
